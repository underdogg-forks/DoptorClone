@section('styles')
  <link rel="stylesheet"
        href="{!! URL::to('assets/backend/default/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css') !!}"/>
@stop
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="widget_tab1">
                ...
                <div class="control-group {{ $errors->has('status') ? 'error' : '' }}">
                  ...
                  <div class="controls line">
                    {!! Form::select('status', {!! trans('cms.slideshow') !!}::all_status(), (!isset($slide)) ?
                    Input::old('status') : $slide->status, array('class'=>'chosen span6 m-wrap',
                    'style'=>'width:285px')) !!}
...
@section('scripts')
  ...
  <script type="text/javascript"
          src="{!! URL::to("assets/backend/default/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js") !!}"></script>
  @parent
  <script>
