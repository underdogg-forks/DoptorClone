          ...
          <div class="clearfix margin-bottom-10">
            @if ($current_user->hasAccess("translation_manager.languages.create"))
              <div class="btn-group pull-right">
                <a href="{!! route($link_type . '.modules.doptor.translation_manager.languages.create') !!}"
            ...
            @if ($current_user->hasAccess("translation_manager.languages.get_install"))
              <div class="btn-group pull-right">
                <a href="{!! route($link_type . '.modules.doptor.translation_manager.languages.get_install') !!}"
                   class="btn btn-success">
                ...
                <td>
                  @if ($language->id != 1)
                    @if ($current_user->hasAccess("translation_manager.languages.edit"))
                      <a
                        href="{!! route($link_type . '.modules.doptor.translation_manager.languages.edit', [$language->id]) !!}"
