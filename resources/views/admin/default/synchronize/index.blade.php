      ...
      <div class="widget light-gray box">
        ...
        <div class="widget-body form">
          @if ($current_user->hasAccess("synchronize.local-to-web"))
            <a href="{!!url('admin/synchronize/localToWeb')!!}" class="btn">{!! trans('cms.synchronize') !!} to
              Remote</a>
          @endif
          <br><br>
          @if ($current_user->hasAccess("synchronize.web-to-local"))
            <a href="{!!url('admin/synchronize/webToLocal')!!}" class="btn">{!! trans('cms.synchronize') !!} from
              Remote</a>
          @endif
        </div>
      </div>
