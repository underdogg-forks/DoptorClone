    ...
    <tr>
      ...
      <td>
        @if (can_user_access_company($company->id))
          <a href="{!! route($link_type . '.modules.' . $module_link . '.companies.branches', $company->id) !!}"
             class="btn btn-mini"><i class="icon-eye-open"></i> View</a>
        @endif
      </td>
      <td>
        @if (can_user_access_company($company->id))
          <a href="{!! route($link_type . '.modules.' . $module_link .'.companies.edit', [$company->id]) !!}"
          ...
          <div class="actions inline">
            ...
            <ul class="btn btn-mini">
              <li>
                ...
                <button type="submit" class="danger" onclick="return deleteRecord($(this))"><i class="icon-trash"></i>
                  Delete
                </button>
                {!! Form::close() !!}
              </li>
