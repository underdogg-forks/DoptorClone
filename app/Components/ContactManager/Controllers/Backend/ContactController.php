    ...
    public function index()
    {
        foreach ($this->forms as $i => $form) {
            ...
            if ($i == 0) {
                ...
                $this->forms[$i]['fields'] = array_diff($this->forms[$i]['fields'],
                  array('image', 'email', 'telephone', 'fax', 'email', 'location', 'city', 'state', 'zip_code'));
                $this->forms[$i]['field_names'] = array_diff($this->forms[$i]['fields'],
                  array('Image', 'Email', 'Telephone', 'Fax', 'Email', 'Location', 'City', 'State', 'Zip_code'));
            } else {
