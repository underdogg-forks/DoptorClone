                ...
                @if (!isset($media_entry))
                  ...
                  <div class="control-group {!! $errors->has('folder') ? 'error' : '' !!}">
                    ...
                    <div class="controls">
                      ...
                      <a href="#" class="btn btn-mini" id="up-folder" title="Go up one directory"><i
                          class="icon-arrow-up"></i></a>
                      <a href="#" class="btn btn-mini" id="reload-folder" title="Reload Folder"><i
                  ...
                  <div id="create-folder" class="modal hide fade" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-footer">
                      <button class="btn" data-dismiss="modal"
                              aria-hidden="true">{!! trans('options.close') !!}</button>
                      <button data-dismiss="modal" class="btn btn-primary"
                              id="folder-submit">{!! trans('options.confirm') !!}</button>
                    </div>
                  </div>
                @else
