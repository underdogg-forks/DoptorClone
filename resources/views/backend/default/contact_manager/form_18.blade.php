...
<ul class="nav nav-tabs">
  <li class="active"><a href="#tab_1_1"
                        data-toggle="tab">{!! trans('fields.contact') !!} {!! trans('fields.details') !!}</a></li>
    ...
    <fieldset>
      ...
      <div class="control-group {!! $errors->has('location') ? 'error' : '' !!}">
        ...
        <div class="controls">
          ...
          <button href="#map-selection" data-toggle="modal"
                  class="demo btn btn-primary">{!! trans('form_messages.select_location') !!}</button>
    ...
    <div class="modal-body">
      ...
      <div class="row-fluid hide">
        <div class="span6">
          ...
          <div class="col-sm-2">
            <input type="text" id="map-lat" name="map-lat" style="width: 110px" class="form-control"
                   value="{!! $entry->location['latitude'] or '' !!}">
          </div>
        </div>
        <div class="span6">
          ...
          <div class="col-sm-2">
            <input type="text" id="map-lon" name="map-lon" style="width: 110px" class="form-control"
                   value="{!! $entry->location['longitude'] or '' !!}">
          </div>
        </div>
      </div>
    </div>
