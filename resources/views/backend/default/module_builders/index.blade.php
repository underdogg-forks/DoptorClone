              ...
              <tr class="">
                ...
                <td>
                  @foreach ($module->forms() as $module_form)
                    ...
                    @if ($current_user->hasAccess('form-builder.edit'))
                      <a href="{!! URL::to($link_type . '/form-builder/' . $module_form->id . '/edit') !!}"
                         class="btn btn-mini" title="{!! trans('options.edit') !!} Form"><i class="icon-edit"></i></a>
                    @endif
                    <br>
                  @endforeach
                </td>
                ...
                <td>
                  @if ($current_user->hasAccess('module-builder.edit'))
                    <a href="{!! URL::to($link_type . '/module-builder/' . $module->id . '/edit') !!}"
                       class="btn btn-mini" title="{!! trans('options.edit') !!} Module"><i class="icon-edit"></i></a>
                  @endif
