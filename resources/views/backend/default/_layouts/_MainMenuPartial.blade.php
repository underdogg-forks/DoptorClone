  ...
  <div id="sidebar" class="nav-collapse collapse">
    ...
    <ul>
      ...
      @if (can_access_menu($current_user, array('users', 'user-groups')))
        <li
          class="has-sub {!! Request::is('backend/users*') ? 'active' : null !!} {!! Request::is('backend/user-groups*') ? 'active' : null !!} ">
          <a href="javascript:;">
            <i class="icon-user"></i>
      ...
      @if (can_access_menu($current_user, array('menu-manager', 'menu-categories', 'menu-positions')))
        <li
          class="has-sub {!! Request::is('backend/menu-manager*') || Request::is('backend/menu-categories*') || Request::is('backend/menu-positions*') ? 'active' : null !!} ">
          <a href="javascript:;">
      ...
      @if (can_access_menu($current_user, array('pages', 'page-categories')))
        <li
          class="has-sub {!! Request::is('backend/pages*') || Request::is('backend/page-categories*') ? 'active' : null !!} ">
          <a href="javascript:;">
            <i class="icon-book"></i>
      ...
      @if (can_access_menu($current_user, array('posts')))
        <li
          class="has-sub {!! Request::is('backend/posts*') || Request::is('backend/post-categories*') ? 'active' : null !!} ">
          <a href="javascript:;">
            <i class="icon-book"></i>
      ...
      @if (can_access_menu($current_user, array('contact-manager')))
        <li
          class="has-sub {!! Request::is('backend/contact-manager*') || Request::is('backend/contact-categories*') ? 'active' : null !!} ">
          <a href="javascript:;">
            <i class="icon-book"></i>
      ...
      @if (can_access_menu($current_user, array('form-categories', 'form-builder', 'module-builder', 'report-builder')))
        <li
          class="has-sub {!! Request::is('backend/form-builder*') || Request::is('backend/form-categories*') || Request::is('backend/module-builder*') || Request::is('backend/report-builder*') ? 'active' : null !!} ">
          <a href="javascript:;">
      ...
      @if (can_access_menu($current_user, array('modules', 'report-generators')))
        <li
          class="has-sub {!! Request::is('backend/modules*') || Request::is('backend/report-generators*') ? 'active' : null !!} ">
          <a href="javascript:;">
            <i class="icon-cog"></i>
      ...
      @if (can_access_menu($current_user, array('backup', 'restore')))
        <li
          class="has-sub {!! Request::is('backend/backup*') || Request::is('backend/restore*') ? 'active' : null !!} ">
          <a href="javascript:;">
