...
@section('scripts')
  <script data-main="{!! URL::to('assets/backend/default/plugins/bootstrap-formbuilder/js/main-built.js') !!}"
          src="{!! URL::to('assets/backend/default/plugins/bootstrap-formbuilder/js/lib/require.js') !!}"></script>
  @parent
  <script>
