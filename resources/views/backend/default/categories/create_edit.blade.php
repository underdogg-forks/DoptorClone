      ...
      <div class="widget box blue tabbable">
        <div class="blue widget-title">
          <h4>
            ...
            @if (!isset($post_cat))
              <span
                class="hidden-480">{!! trans('options.create_new') !!} {!! Str::title($type) !!} {!! trans('cms.category') !!}</span>
            @else
              <span
                class="hidden-480">{!! trans('options.edit') !!} {!! Str::title($type) !!} {!! trans('cms.category') !!}</span>
            @endif
            &nbsp;
          </h4>
        </div>
