                    ...
                    <label class="checkbox">
                      @if ($current_user->hasAccess('superuser'))
                        <input type="checkbox" value="1" name="superuser"
                               id="all-access" {!! (isset($user_group->permissions['superuser'])) ? 'checked' : '' !!}/>
                        All Access
                      @endif
                    </label>
                  </div>
                    ...
                    <label class="checkbox">
                      @if ($current_user->hasAccess('backend'))
                        <input type="checkbox" value="1"
                               name="backend" {!! (isset($user_group->permissions['backend'])) ? 'checked' : '' !!}/>
                        Backend Access
                      @endif
                    </label>
                  </div>
                            ...
                            <div class="controls line">
                              ...
                              <label class="checkbox">
                                @if ($current_user->hasAccess($abbr.'.index'))
                                  <input type="checkbox" value="1"
                                         name="{!! $abbr !!}.index" {!! (isset($user_group->permissions[$abbr.'.index'])) ? 'checked' : '' !!}/>
                                  List All Records
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess($abbr.'.show'))
                                  <input type="checkbox" value="1"
                                         name="{!! $abbr !!}.show" {!! (isset($user_group->permissions[$abbr.'.show'])) ? 'checked' : '' !!}/>
                              ...
                              <label class="checkbox">
                                @if ($current_user->hasAccess($abbr.'.create'))
                                  <input type="checkbox" value="1"
                                         name="{!! $abbr !!}.create" {!! (isset($user_group->permissions[$abbr.'.create'])) ? 'checked' : '' !!}/> {!! trans('options.create_new') !!}
                                  Record
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess($abbr.'.edit'))
                                  <input type="checkbox" value="1"
                                         name="{!! $abbr !!}.edit" {!! (isset($user_group->permissions[$abbr.'.edit'])) ? 'checked' : '' !!}/> {!! trans('options.edit') !!}
                                  Record
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess($abbr.'.destroy'))
                                  <input type="checkbox" value="1"
                                         name="{!! $abbr !!}.destroy" {!! (isset($user_group->permissions[$abbr.'.destroy'])) ? 'checked' : '' !!}/> {!! trans('options.delete') !!}
                                  Record
                                @endif
                              </label>
                              <label class="checkbox">
                              ...
                              @foreach ((array)$permissions as $permission => $desc)
                                <label class="checkbox">
                                  @if ($current_user->hasAccess("{$name}.{$permission}"))
                                    <input type="checkbox" value="1"
                                           name="{!! $name !!}_{!! $permission !!}" {!! (isset($user_group->permissions["{$name}.{$permission}"])) ? 'checked' : '' !!}/> {!! $desc !!}
                                  @endif
                                </label>
                              @endforeach
                            ...
                            <div class="controls line">
                              ...
                              <label class="checkbox">
                                @if ($current_user->hasAccess('modules.'.$abbr.'.index'))
                                  <input type="checkbox" value="1"
                                         name="modules.{!! $abbr !!}.index" {!! (isset($user_group->permissions['modules.'.$abbr.'.index'])) ? 'checked' : '' !!}/>
                                  List All Records
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess('modules.'.$abbr.'.show'))
                                  <input type="checkbox" value="1"
                                         name="modules.{!! $abbr !!}.show" {!! (isset($user_group->permissions['modules.'.$abbr.'.show'])) ? 'checked' : '' !!}/>
                                  View Individual Records
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess('modules.'.$abbr.'.create'))
                                  <input type="checkbox" value="1"
                                         name="modules.{!! $abbr !!}.create" {!! (isset($user_group->permissions['modules.'.$abbr.'.create'])) ? 'checked' : '' !!}/> {!! trans('options.create_new') !!}
                                  Record
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess('modules.'.$abbr.'.edit'))
                                  <input type="checkbox" value="1"
                                         name="modules.{!! $abbr !!}.edit" {!! (isset($user_group->permissions['modules.'.$abbr.'.edit'])) ? 'checked' : '' !!}/> {!! trans('options.edit') !!}
                                  Record
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess('modules.'.$abbr.'.destroy'))
                                  <input type="checkbox" value="1"
                                         name="modules.{!! $abbr !!}.destroy" {!! (isset($user_group->permissions['modules.'.$abbr.'.destroy'])) ? 'checked' : '' !!}/> {!! trans('options.delete') !!}
                                  Record
                                @endif
                              </label>
                              <label class="checkbox">
