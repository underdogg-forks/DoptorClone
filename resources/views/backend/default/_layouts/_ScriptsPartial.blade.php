...
<script src="{!! URL::to("assets/backend/default/plugins/jquery-ui/jquery-ui-1.10.1.custom.min.js") !!}"
        type="text/javascript"></script>
<script src="{!! URL::to("assets/backend/default/plugins/bootstrap/js/bootstrap.min.js") !!}"
        type="text/javascript"></script>
<!--[if lt IE 9]>
...
") !!}" ></script>
<![endif]-->
<script src="{!! URL::to("assets/backend/default/plugins/breakpoints/breakpoints.js") !!}"
        type="text/javascript"></script>
<!-- IMPORTANT! jquery.slimscroll.min.js depends on jquery-ui-1.10.1.custom.min.js -->
<script src="{!! URL::to("assets/backend/default/plugins/jquery-slimscroll/jquery.slimscroll.min.js") !!}"
        type="text/javascript"></script>
...
<script src="{!! URL::to("assets/backend/default/plugins/uniform/jquery.uniform.min.js") !!}"
        type="text/javascript"></script>
<!-- END CORE PLUGINS -->
@if(ends_with(Request::url(), 'create') || ends_with(Request::url(), 'edit'))
  <script type="text/javascript"
          src="{!! URL::to('assets/backend/default/plugins/chosen-bootstrap/chosen/chosen.jquery.min.js') !!}"></script>
@endif
@section('scripts')
