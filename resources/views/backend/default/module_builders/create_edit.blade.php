    ...
    <div class="span12">
      <div class="widget box blue" id="form_wizard_1">
        <div class="blue widget-title">
          <h4>
            <i class="icon-reorder"></i> {!! trans('cms.module_builder') !!} - <span
              ...
              <div class="tab-pane" id="tab2">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    <div
                      class="pull-right">{!! HTML::link("$link_type/form-builder/create", trans('options.create_new'). " " . trans('fields.form'), array('class'=>'pull-right btn btn-mini mb-15')) !!}</div>
