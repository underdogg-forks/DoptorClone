                            ...
                            <div class="controls line">
                              ...
                              <label class="checkbox">
                                @if ($current_user->hasAccess($abbr.'.create'))
                                  <input type="checkbox" value="1"
                                         name="{!! $abbr !!}.create" {!! (isset($user_group->permissions[$abbr.'.create'])) ? 'checked' : '' !!}/>
                                  Create New Record
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess($abbr.'.edit'))
                                  <input type="checkbox" value="1"
                                         name="{!! $abbr !!}.edit" {!! (isset($user_group->permissions[$abbr.'.edit'])) ? 'checked' : '' !!}/>
                                  Edit Record
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess($abbr.'.destroy'))
                                  <input type="checkbox" value="1"
                                         name="{!! $abbr !!}.destroy" {!! (isset($user_group->permissions[$abbr.'.destroy'])) ? 'checked' : '' !!}/>
                                  Delete Record
                                @endif
                              </label>
                              <label class="checkbox">
                            ...
                            <div class="controls line">
                              ...
                              <label class="checkbox">
                                @if ($current_user->hasAccess('modules.'.$abbr.'.create'))
                                  <input type="checkbox" value="1"
                                         name="modules.{!! $abbr !!}.create" {!! (isset($user_group->permissions['modules.'.$abbr.'.create'])) ? 'checked' : '' !!}/>
                                  Create New Record
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess('modules.'.$abbr.'.edit'))
                                  <input type="checkbox" value="1"
                                         name="modules.{!! $abbr !!}.edit" {!! (isset($user_group->permissions['modules.'.$abbr.'.edit'])) ? 'checked' : '' !!}/>
                                  Edit Record
                                @endif
                              </label>
                              <label class="checkbox">
                                @if ($current_user->hasAccess('modules.'.$abbr.'.destroy'))
                                  <input type="checkbox" value="1"
                                         name="modules.{!! $abbr !!}.destroy" {!! (isset($user_group->permissions['modules.'.$abbr.'.destroy'])) ? 'checked' : '' !!}/>
                                  Delete Record
                                @endif
                              </label>
                              <label class="checkbox">
