...
<head>
  ...
  <link href="{!! URL::to("assets/backend/default/plugins/bootstrap/css/bootstrap-responsive.min.css") !!}"
        rel="stylesheet"/>
  ...
  <link href="{!! URL::to("assets/backend/default/plugins/uniform/css/uniform.default.css") !!}" rel="stylesheet"
        type="text/css"/>
