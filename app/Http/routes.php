...
Route::group(array(
  'prefix' => 'backend',
  'middleware' => array('auth', 'auth.backend', 'auth.permissions', 'auth.pw_6_months')
), function () {
    ...
    Route::post('users/{id}/activate',
      array('as' => 'backend.users.activate', 'uses' => 'Backend\UserController@activate'));
    Route::post('users/{id}/deactivate',
      array('as' => 'backend.users.deactivate', 'uses' => 'Backend\UserController@deactivate'));
    ...
    Route::put('users/change-password', array(
      'uses' => 'Backend\UserController@putChangePassword',
    ...
    Route::get('modules/install',
      array('as' => 'backend.modules.create', 'uses' => 'Backend\ModulesController@getInstall'));
    Route::post('modules/install',
      array('as' => 'backend.modules.store', 'uses' => 'Backend\ModulesController@postInstall'));
    Route::delete('modules/delete/{id}',
      array('uses' => 'Backend\ModulesController@getDelete', 'as' => 'backend.modules.destroy'));
    ...
    Route::any('media-manager/create_folder',
      'Components\MediaManager\Controllers\Backend\MediaManagerController@create_folder');
    Route::any('media-manager/folder_contents',
      'Components\MediaManager\Controllers\Backend\MediaManagerController@folder_contents');
    ...
    Route::delete('backup/delete/{id}',
      array('uses' => 'Backend\BackupRestoreController@deleteBackup', 'as' => 'backups.destroy'));
    ...
    Route::get('report-builder/module-fields/{id}',
      'Components\ReportBuilder\Controllers\Backend\ReportBuilderController@getModuleFields');
    Route::get('report-builder/download/{id}',
      'Components\ReportBuilder\Controllers\Backend\ReportBuilderController@download');
    Route::resource('report-builder', 'Components\ReportBuilder\Controllers\Backend\ReportBuilderController');
    Route::get('report-generators/generate/{id}',
      'Components\ReportGenerator\Controllers\Backend\ReportGeneratorController@getGenerate');
    Route::post('report-generators/generate/{id}', array(
      ...
      'as' => 'backend.report-generators.generate'
    ));
    Route::get('report-generators/install',
      'Components\ReportGenerator\Controllers\Backend\ReportGeneratorController@create');
...
Route::group(array('prefix' => 'admin'), function () {
    ...
    Route::resource('form-categories', 'Backend\FormCategoriesController');
    Route::post('users/{id}/activate',
      array('as' => 'admin.users.activate', 'uses' => 'Backend\UserController@activate'));
    Route::post('users/{id}/deactivate',
      array('as' => 'admin.users.deactivate', 'uses' => 'Backend\UserController@deactivate'));
    // For changing the current user's password
    Route::get('users/change-password', 'Backend\UserController@getChangePassword');
    Route::put('users/change-password',
      array('uses' => 'Backend\UserController@putChangePassword', 'as' => 'admin.users.change-password'));
    Route::get('synchronize', 'Backend\SynchronizeController@getIndex');
    Route::get('synchronize/localToWeb', 'Backend\SynchronizeController@getLocalToWeb');
    Route::post('synchronize/localToWeb', 'Backend\SynchronizeController@postLocalToWeb');
    Route::get('synchronize/webToLocal', 'Backend\SynchronizeController@getWebToLocal');
    ...
    Route::get('modules/install',
      array('as' => 'admin.modules.create', 'uses' => 'Backend\ModulesController@getInstall'));
    Route::post('modules/install',
      array('as' => 'admin.modules.store', 'uses' => 'Backend\ModulesController@postInstall'));
    Route::delete('modules/delete/{id}',
      array('uses' => 'Backend\ModulesController@getDelete', 'as' => 'admin.modules.destroy'));
    Route::get('module-builder/download/{id}', 'Backend\ModuleBuilderController@download');
    Route::get('module-builder/form-dropdowns/{id}', 'Backend\ModuleBuilderController@getFormDropdowns');
    Route::resource('module-builder', 'Backend\ModuleBuilderController');
    // For pages and posts
