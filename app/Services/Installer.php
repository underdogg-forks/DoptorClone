    ...
    public function dbMigrate($input)
    {
        ...
        try {
            ...
            Artisan::call('vendor:publish',
              ['--provider' => 'Barryvdh\TranslationManager\ManagerServiceProvider', '--tag' => ['migrations']]);
            // Migrate all the tables
            Artisan::call('migrate');
            Artisan::call('vendor:publish',
              ['--provider' => 'Barryvdh\TranslationManager\ManagerServiceProvider', '--tag' => ['config']]);
            ...
            Artisan::call('db:seed',
              ['--class' => 'Modules\Doptor\TranslationManager\Database\Seeds\ModulesTableSeeder']);
            Artisan::call('db:seed',
              ['--class' => 'Modules\Doptor\TranslationManager\Database\Seeds\LanguageTableSeeder']);
