    ...
    <div class="span12">
      ...
      <div class="widget light-gray box">
        <div class="blue widget-title">
          <h4><i class="icon-th-list"></i> {!! trans('options.install_new') !!} {!! trans('cms.report_generator') !!}
          </h4>
        </div>
        <div class="widget-body form">
          ...
          <div class="form-actions">
            <button type="submit" class="btn btn-primary"><i class="icon-ok"></i> {!! trans('options.install_new') !!}
            </button>
          </div>
