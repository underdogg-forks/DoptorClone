...
@section('content')
  ...
  <script type="text/javascript"
          src="{!! URL::to('assets/backend/default/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js') !!}"></script>
  <script type="text/javascript"
          src="{!! URL::to('assets/backend/default/plugins/jquery-validation/dist/jquery.validate.min.js') !!}"></script>
  <script type="text/javascript"
          src="{!! URL::to('assets/backend/default/plugins/jquery-validation/dist/additional-methods.min.js') !!}"></script>
